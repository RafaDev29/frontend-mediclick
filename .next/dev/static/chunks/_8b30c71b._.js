...
"[project]/features/auth/services/auth.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const authService = {
    login: async (payload)=>{
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", payload);
        return data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/auth/services/auth.service.ts [app-client] (ecmascript)");
...
function LoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setSuccess("");
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].login({
                email,
                password
            });
            if (res.success) {
...
_s(LoginForm, "QVxX8mYvuIRwd1/kNfBGvYXBiX4=", false, function() {
    return [
...
//# sourceMappingURL=_8b30c71b._.js.map