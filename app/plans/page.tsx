      ...
      <div className="plans-root">
        ...
        <section className="plans-section">
          <div className="plans-grid">
            {plans.map((plan, i) => (
              <div className={`plan-card ${plan.highlight ? "featured" : ""}`} key={i}>
                {plan.highlight && <span className="featured-badge">Más popular</span>}
                  ...
                  {plan.features.map((f, j) => (
                    <li key={j}>
                      <div className="check-icon">
                        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke={plan.highlight ? "white" : "#1457c0"} strokeWidth="3">
                ...
                <a href="/login" className="plan-cta">{plan.cta}</a>
              </div>
            ))}
          </div>
        </section>
